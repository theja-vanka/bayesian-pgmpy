...
print(cancer_infer.query(variables=['Dyspnoea'], joint=False, evidence={'Smoker': 1})['Dyspnoea'])
print(cancer_infer.query(variables=['Xray'], joint=False, evidence={'Dyspnoea': 1, 'Smoker':0})['Xray'])